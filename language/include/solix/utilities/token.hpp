...
enum class TokenType {
  ...
  KEYWORD_STATIC, KEYWORD_INLINE, KEYWORD_ALIAS,
  KEYWORD_PUBLIC, KEYWORD_NATIVE, KEYWORD_PROTECTED, KEYWORD_PRIVATE, KEYWORD_INTERNAL,
  KEYWORD_PACKAGE, KEYWORD_NEW, KEYWORD_OPERATOR, KEYWORD_EXTENDS, KEYWORD_SUPER,
  ...
  PUNCTUATION_SEMICOLON, PUNCTUATION_COMMA, PUNCTUATION_DOT, PUNCTUATION_COLON,
