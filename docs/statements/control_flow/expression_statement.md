...
> [!NOTE]
> For all positive test scenarios and negative failure cases for this construct, see [ExpressionStatement in TEST_SPECIFICATION.md](../../TEST_SPECIFICATION.md#expressionstatement).
